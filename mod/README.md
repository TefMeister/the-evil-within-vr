...
This folder holds **only files we create** for the mod. No game files are
...
| --- | --- |
| **`mod/`** ← you are here | The mod itself — a `winmm.dll` proxy driving stereo via D3D11 hooks (pre-release; source). |
